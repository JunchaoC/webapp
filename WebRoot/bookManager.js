Ext.onReady(function(){
	...
	Ext.define("MyApp.model.Book", {
	    ...
	    fields: [
	        ...
	        { name: 'movieimageUrl', type: 'string' },
		    					...
		    					items:[
		    						{
				    					...
				    					columns:[
				    						...
				    						{header:"书名",dataIndex:"moviename",sortable:true,
				    							editor:new Ext.form.TextField({
				    								minLength:3,
				    								minLengthText:"书名长度不能小于3个字符",
				    								maxLength:12,
				    								maxLengthText:"书名长度不能大于12个字符",
				    								allowBlank:false,
				    								blankText:"书名不能为空"
				    							})
				    						},
				    						{header:"封面地址",dataIndex:"movieimageUrl",sortable:true,
				    							editor:new Ext.form.TextField({
				    								minLength:3,
				    								minLengthText:"封面地址长度不能小于3个字符",
				    								maxLength:12,
				    								maxLengthText:"封面地址长度不能大于12个字符",
				    								allowBlank:false,
				    								blankText:"封面地址不能为空"
				    							})
				    						},
				    						{header:"出版社",dataIndex:"grade",sortable:true,
				    							editor:new Ext.form.TextField({
				    								minLength:3,
				    								minLengthText:"出版社长度不能小于3个字符",
				    								maxLength:20,
				    								maxLengthText:"出版社长度不能大于12个字符",
				    								allowBlank:false,
				    								blankText:"出版社不能为空"
				    							})
				    						}
